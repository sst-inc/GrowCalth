...
const Health = () => {
    return (
        ...
        <View style={{backgroundColor: '#A0C4E2',  height: 30, marginTop: 20, flex: 1, justifyContent: 'center', alignItems: 'center', marginHorizontal: -33}}>
          ...
          <View style={{width: 380, height: 185, borderRadius: 10, borderColor: 'black', borderWidth: 1.23, marginTop: 15, marginLeft: 23}}>
            ...
            <TouchableOpacity style={{width: 377, backgroundColor: 'white', height: 60}}>
              {/* Second Piece of code */}
              <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center'}}>
              <Icons name="food-drumstick-off" size={25} color="black" style={{paddingHorizontal: 10}}/>
              <Text style={{paddingHorizontal: 5, fontSize: 16.6, fontWeight: '600'}}>Dietary Restrictions</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity style={{width: 377, backgroundColor: 'white', height: 62, borderColor: 'black', borderTopWidth: 1.23, borderBottomRightRadius: 10, borderBottomLeftRadius: 10}}>
              {/* Third Piece of code */}
              <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center'}}>
              <Icon name="child" size={32} color="black" style={{paddingHorizontal: 10}}/>
              <Text style={{paddingHorizontal: 5, fontSize: 16.6, fontWeight: '600'}}>Body Measurements</Text>
              </View>
            </TouchableOpacity>
          </View>       
           </View>

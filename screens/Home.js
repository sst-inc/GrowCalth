import { TouchableOpacity, StyleSheet, SafeAreaView, ScrollView, Text, View, Image, AppState } from 'react-native';
...
function Homes() {
  ...
  const randomQuote = () => {
    setIsLoading(true)
    fetch("https://zenquotes.io/api/quotes/author/sun-tzu/[YOUR_KEY]").then(res => res.json).then(result => {
      console.log(result)
      setQuote(result.content);
      setAuthor(result.Author);
      setIsLoading(false)
    ...
    <SafeAreaView style={{backgroundColor: '#FFFFF'}}>
      <ScrollView>
        ...
        <View style={{backgroundColor: '#F2F2F2'}}>
          <View>
          <TouchableOpacity style={{width: 179, height: 170, marginHorizontal: 220, borderRadius: 15, marginTop: 30, marginBottom: -175, 
          ...
          <TouchableOpacity style={{paddingHorizontal: 220, marginTop: -80}}
                onPress={() => navigation.navigate("Progress")}
                >
            <View style={{width: 179,height: 250,borderRadius: 15,borderColor: 'white', borderWidth: 0, paddingHorizontal: 10, shadowColor: 'black', shadowColor: '#171717', backgroundColor: 'white',
    shadowOffset: {width: -2, height: 4},
    shadowOpacity: 1,
    shadowRadius: 3}}>
              {/* Progress */}
        ...
        <StatusBar style="auto" />
        <TouchableOpacity style={{paddingHorizontal: 20, paddingTop: 60,}}>
        ...
        <TouchableOpacity style={{height: 130, width: 379, borderRadius: 10, borderWidth: 0, marginLeft: 20, bottom: 240, 
      ...
      >
        ...
        <TouchableOpacity style={{height: 165, width: 379, borderRadius: 15, backgroundColor: '#754F5B', marginHorizontal: 20, marginTop: -217,

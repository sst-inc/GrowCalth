    ...
    return (
        ...
        pages={[
            ...
            },
            {
                ...
                titleStyles: {fontWeight:'bold'},
                subTitleStyles: {color: 'black'},
                image: <Image source={{uri: 'https://www.kindpng.com/picc/m/504-5044310_icon-quote-graphic-design-hd-png-download.png'}}  style={{width: windowWidth-20, height: windowHeight-520}}/>,
                title: 'Motivational Quotes',
                subtitle: 'Having a positive mindset daily helps with you mental health!',
            },
            {
                backgroundColor: '#fff',
                titleStyles: {fontWeight:'bold'},
                subTitleStyles: {color: 'black'},
                image: <Image source={require('../assets/LeaderBoard.png')}  style={{width: windowWidth-20, height: windowHeight-520}}/>,
                title: 'Compete with others!',
                subtitle: 'Take part in challenges to gain house points for your respective houses!',
            },
            {
                backgroundColor: '#fff',
                image:  <Picker

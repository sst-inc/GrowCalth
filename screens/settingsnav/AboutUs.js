...
const AboutUs = () => {
    ...
    return (
        ...
        <View style={{backgroundColor: 'white'}}>
            ...
            <View style={{width: windowWidth-30, left: 16, borderRadius: 14, justifyContent: 'center', alignItems: 'center',backgroundColor: '#F6E8EA', hadowColor: 'black', shadowColor: '#171717',

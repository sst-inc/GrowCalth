...
const House = () => {
    ...
    return (
      <View style={{backgroundColor: 'white', flex: 1}}>
        ...
        <View style={{height: 30, backgroundColor: '#F7826F', justifyContent: 'center', alignItems: 'center', width: windowWidth}}>
          <Text style={{fontSize: 16, textAlign: 'center'}}>H O U S E  L E A D E R S</Text>
          </View>

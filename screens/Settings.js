...
import {Text, View, SafeAreaView, ScrollView, TouchableOpacity, Dimensions, Switch, StyleSheet , Alert} from 'react-native'
  ...
  const navigation = useNavigation();
    return (
      <SafeAreaView  style={{backgroundColor: '#FFFF'}}>
        ...
        <View style={{width: windowWidth- 40, height: 125, borderRadius: 10, borderColor: 'black', borderWidth: 1.23, marginTop: 15, marginLeft: -10}}>
            <TouchableOpacity style={{width: windowWidth- 43, backgroundColor: '#', height: 60, borderTopRightRadius: 10, borderTopLeftRadius: 10, borderColor: 'black', borderBottomWidth: 1.23 }}
            ...
            <TouchableOpacity style={{width: windowWidth- 55, backgroundColor: 'white', height: 60, borderRadius: 10}}
...
{/* Health */}
        ...
        <View style={{backgroundColor: '#A0C4E2',  height: 30, marginTop: 20, flex: 1, justifyContent: 'center', alignItems: 'center', marginHorizontal: -33}}>
          ...
          <View style={{width: windowWidth- 40, height: 65, borderRadius: 10, borderColor: 'black', borderWidth: 1.23, marginTop: 15, marginLeft: 23}}>
            <TouchableOpacity style={{width: windowWidth- 55, backgroundColor: 'white', height: 60, borderTopRightRadius: 10, borderTopLeftRadius: 10, borderRadius: 10}}
        ...
        <View style={{width: windowWidth-41, height: 130, borderRadius: 10, borderColor: 'black', borderWidth: 1.23, marginTop: 15, marginLeft: 23}}>
            <TouchableOpacity style={{width: windowWidth- 44, backgroundColor: 'white', height: 60, borderTopRightRadius: 10, borderTopLeftRadius: 10, borderColor: 'black', borderBottomWidth: 1.23 }}
            onPress={() => navigation.navigate("Account Info")}>
              ...
              <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center'}}>
              <Icons name="account-outline" size={31} style={{paddingHorizontal: 10}}/>
              <Text style={{paddingHorizontal: 5, fontSize: 16.6, fontWeight: '600'}}>Account Info</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity style={{width: windowWidth- 50, backgroundColor: 'white', height: 60}} onPress={() => navigation.navigate("House Info")}>
              {/* Second Piece of code */}
              <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'centers'}}>
              <Iconse name="moon-outline" size={30} style={{paddingHorizontal: 10}}/>
              <Text style={{paddingHorizontal: 5, fontSize: 16.6, fontWeight: '600'}}>House</Text>
          ...
          <View style={styles.containers}>
            <View style={{backgroundColor: 'black', borderRadius: 10, paddingVertical: 10, top: 10}}>
      </View>
      <TouchableOpacity

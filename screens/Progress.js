...
import { StyleSheet, Text, View, Dimensions, AppState, ScrollView, KeyboardAvoidingView, Platform, TextInput, TouchableOpacity, Keyboard } from 'react-native';
    ...
    return (
      <ScrollView>
        <View style={{paddingHorizontal: 30, paddingTop: 15, flex: 1}}>
            ...
            <View style={{width: 80, height: 80, borderRadius: 40, backgroundColor: 'white', marginHorizontal: 260, top: 30}}>
                {/* Calories */}
                <View style={styles.middile}>
                <Text style={{fontWeight: 'bold', fontSize: 20}}>{caloriesBurnt}</Text>
                <Text>kcal</Text>
                </View>
            </View>
        <View style={{width: 200, height: 200, borderRadius: 100, backgroundColor: 'white', top: -155}}>
            {/* Steps */}
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
            <Text style={{fontWeight: 'bold', fontSize: 40}}>{stepCount}</Text>
            <Text style={{fontWeight: '500', fontSize: 20}}>steps</Text>
            </View>

        </View>
        <View>
          <View style={{borderRadius:  16, backgroundColor: 'white', height: 220, width: Dimensions.get('window').width - 30, marginTop: -140, marginHorizontal: -15}}>
                  <View style={{}}>
                  <LineChart
        data={{
